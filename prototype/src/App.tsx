...
function buildEdgeDraftApplyScript(input: {
  ...
  return [
    ...
    `  sys.exit(int(os.environ.get("EXIT_CODE_SUCCESS", "${exitSuccess}")))`,
    ...
    `  sys.exit(int(os.environ.get("EXIT_CODE_PREFLIGHT", "${exitPreflight}")))`,
    "for label, matched in hits.items():",
    ...
    "  fi",
    "else",
    "  echo \"[validation] target file missing: $TARGET_FILE (warning), skip workflow/context precheck\"",
    "fi",
